...
interface ServerInterface {
    ...
    fun sendEncapsulated(sessionId: Int, packet: Any, immediate: Boolean = false)

    fun sendRaw(address: InetSocketAddress, payload: ByteBuf)
    ...
    fun setPacketPerTickLimit(limit: Int)
